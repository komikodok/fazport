...
const AssistantButton = ({handleClick, openAssistant}) => {
    ...
    return (
        <button className={`fixed cursor-pointer w-14 h-14 bottom-0 ring-0 md:left-10 max-sm:scale-80 rounded-full m-10 ${openAssistant ? "translate-y-30" : "translate-y-0"} transform transition-transform ease-out duration-400 md:duration-200 overflow-hidden`}>
            <img 
