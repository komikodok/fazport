...
const Assistant = () => {
    ...
    return (
        <>
            ...
            <div className={`${openAssistant ? "translate-y-0" : "translate-y-full"} fixed bottom-0 right-1/2 translate-x-1/2 w-full md:w-[90%] lg:w-[70%] h-[80%] 2xl:h-[60%] max-sm:h-[50%] transition-all duration-75 bg-gradient-to-b from-transparent to-slate-950`}>
